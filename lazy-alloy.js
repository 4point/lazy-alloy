...
Compiler = (function() {
  ...
  Compiler.prototype.widgets = function() {
    ...
    for (j = 0, len = widgets.length; j < len; j++) {
      ...
      results.push(this.process("widgets/" + widget + "/controllers/", "coffee", "js"));
    }
    return results;
  };
...
Generator = (function() {
  var createController, createLibrary, createModel, createStyle, createTheme, createView, createWidget, execUnlessExists, mkdir, not_yet_implemented, touch;
  ...
  createTheme = function(name) {
    ...
    return touch(app.subfolder + 'themes/' + name + '.coffee');
  };
